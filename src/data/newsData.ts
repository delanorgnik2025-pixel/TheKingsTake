...
export const ARTICLES: Article[] = [
  ...
  },
  {
    ...
    title: "How to Search the Digitized Dawes Records Without Stopping at the Index",
    excerpt: "NARA provides searchable census cards and enrollment applications, but serious research still requires comparing the roll, family card, application packet, and related records.",
    body: [
      "The National Archives and Records Administration provides digitized Dawes census cards and enrollment applications through the National Archives Catalog. These records relate to enrollment in the Cherokee, Choctaw, Chickasaw, Muscogee (Creek), and Seminole Nations in Indian Territory between 1898 and 1914.",
      "A Dawes search should not end with a name in an index. The final roll can provide an enrollment number and census card number. The census card may identify relatives, age, sex, blood degree, parents, earlier roll references, births, deaths, or marital changes. Freedmen cards may also contain fields concerning former enslavers.",
      "The related enrollment application may contain variant name spellings, residence, extended family, testimony, correspondence, affidavits, and supporting documents. NARA states that approved, doubtful, rejected, and stricken applicants can appear in the census-card series, although some doubtful and rejected groups have limited indexes.",
      "Land allotment jackets are a separate record set for approved enrollees. They may contain family information, legal land descriptions, plat maps, improvements, correspondence, and contested-selection notices. Some associated collections are hosted through FamilySearch or subscription services, so access conditions vary by collection.",
      "The Dawes records cover only the Five Tribes in Indian Territory and cannot answer every Indigenous ancestry question. Researchers whose families were connected to other nations or places should also examine Indian Census Rolls, federal census schedules, vital records, land records, church records, military files, state archives, and local court records.",
      "TheKingsTake ancestry tools treat every index entry as a lead rather than a final conclusion. Compare names, alternate spellings, relatives, neighbors, dates, and locations across multiple original records, and contact the appropriate sovereign tribal nation directly for citizenship or enrollment requirements.",
    ],
    category: "HERITAGE",
