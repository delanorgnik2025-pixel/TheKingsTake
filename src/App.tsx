...
import RootsRegistryLanding from './pages/RootsRegistryLanding'
import RootsRegistryWizard from './pages/RootsRegistryWizard'
  ...
  return (
    <AppLayout>
      <Routes>
        ...
        <Route path="/roots-registry" element={<RootsRegistryLanding />} />
        <Route path="/roots-registry/register" element={<RootsRegistryWizard />} />
