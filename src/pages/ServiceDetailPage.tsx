...
const FALLBACK_SERVICES: Record<string, {
  ...
  "ghostwriting": {
    id: 8, slug: "ghostwriting", name: "Ghostwriting Services",
    duration: "Per project", priceDisplay: "From $1,500", type: "one-time",
    shortDescription: "Your name. My words. Professional ghostwriting for leaders, creators, and visionaries.",
    fullDescription: `When you have a message but not the time or craft to write it — I become your voice. Books, articles, speeches, and social content that sounds exactly like you, because it is built around you.\n\nYou get all the credit. I do all the craft. Your voice, amplified.`,
    features: JSON.stringify(["Complete voice-matching process","Confidentiality guaranteed","Unlimited revisions within scope","Full rights transfer","Ongoing content partnerships"]),
    tiers: [
      { label: "Articles & Blog Posts", price: "$500+", desc: "Single piece ghostwritten in your voice" },
      { label: "Social Media Content Series", price: "$750+", desc: "Multi-week content calendar and posts" },
      { label: "Op-Eds & Commentary", price: "$1,000+", desc: "Published commentary under your name" },
      { label: "Book Ghostwriting", price: "$5,000+", desc: "Full manuscript: concept to completion" },
      { label: "Speech Series & Campaign Messaging", price: "$2,500+", desc: "Multi-speech package with consistent voice" },
      { label: "Complete Voice & Brand Development", price: "Custom", desc: "Full personal brand writing partnership" },
    ],
  },
  "content-writing": {
    id: 9, slug: "content-writing", name: "Content Writing & Copywriting",
    duration: "Per project", priceDisplay: "From $75", type: "one_time",
    shortDescription: "Website copy, blog posts, marketing content — words that convert and connect.",
    fullDescription: `Every piece of content is strategically crafted to engage your audience, communicate your value, and drive action. SEO-informed, brand-aligned, and built for results.\n\nFrom a single blog post to a complete website overhaul — content that works as hard as you do.`,
    features: JSON.stringify(["SEO-informed content strategy","Brand-aligned messaging","Conversion-focused copywriting","Multi-format expertise","Monthly retainer options"]),
    tiers: [
      { label: "Blog Posts & Articles", price: "$75+", desc: "SEO-optimized content for your platform" },
      { label: "Website Copy & Landing Pages", price: "$300+", desc: "High-converting web copy that sells" },
      { label: "Email Sequences & Newsletters", price: "$500+", desc: "Nurture sequences and broadcast emails" },
      { label: "Marketing & Sales Copy", price: "$250+", desc: "Ads, sales pages, product descriptions" },
      { label: "Press Releases & Media Kits", price: "$350+", desc: "Professional PR materials" },
      { label: "Monthly Content Retainers", price: "$500+/mo", desc: "Ongoing content production partnership" },
    ],
  },
};
