  ...
  return (
    <div className="min-h-screen bg-[#FAFAFA] flex items-center justify-center px-6">
      <div className="text-center max-w-md">
        <h1 className="text-6xl text-[#25364B]/10 font-bold mb-4">404</h1>
        <h2 className="text-xl text-[#25364B] font-medium mb-2">Article Not Found</h2>
        <p className="text-sm text-[#25364B]/50 mb-6">The story you're looking for may have moved or is still being researched.</p>
  ...
  return (
    <Link to={`/article/${article.slug}`} className="group flex gap-3 p-3 rounded-xl border border-[rgba(0,0,0,0.06)] hover:border-[rgba(255,149,0,0.3)] bg-white hover:bg-[rgba(255,149,0,0.02)] transition-all">
      ...
      <div className="flex-1 min-w-0">
        ...
        <div className="flex items-center gap-2 mt-1 text-[9px] text-[#25364B]/30">
...
export default function ArticlePage() {
  ...
  return (
    <div className="min-h-screen bg-[#FAFAFA]">
      ...
      <div className="sticky top-0 z-50 bg-white/90 backdrop-blur-md border-b border-[rgba(0,0,0,0.06)]">
        <div className="max-w-5xl mx-auto px-4 md:px-6 h-14 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <button onClick={() => navigate(-1)} className="text-[#25364B]/40 hover:text-[#FF9500] transition-colors">
              <ArrowLeft size={18} />
            </button>
            <Link to="/" className="text-[10px] uppercase tracking-[0.15em] text-[#FF9500] font-bold">#TheKingsTake</Link>
            <ChevronRight size={10} className="text-[#25364B]/15" />
            <Link to="/#news" className="text-[10px] uppercase tracking-wider text-[#25364B]/40 hover:text-[#FF9500] transition-colors">News</Link>
            <ChevronRight size={10} className="text-[#25364B]/15" />
            <span className="text-[10px] uppercase tracking-wider text-[#25364B]/25 truncate max-w-[100px]">{article.category}</span>
          </div>
          <div className="flex items-center gap-2">
            <button onClick={() => alert('Share functionality coming soon')} className="w-8 h-8 rounded-full border border-[rgba(0,0,0,0.08)] flex items-center justify-center text-[#25364B]/30 hover:text-[#FF9500] hover:border-[rgba(255,149,0,0.3)] transition-all">
              <Share2 size={13} />
            </button>
            <button onClick={() => alert('Bookmarked')} className="w-8 h-8 rounded-full border border-[rgba(0,0,0,0.08)] flex items-center justify-center text-[#25364B]/30 hover:text-[#FF9500] hover:border-[rgba(255,149,0,0.3)] transition-all">
              <Bookmark size={13} />
            </button>
          </div>
        </div>
      ...
      {/* Hero Image */}
      <div className="relative h-[250px] md:h-[400px] bg-[#14202E]">
        ...
        <div className="absolute inset-0 bg-gradient-to-b from-[#14202E]/30 to-transparent" />
      </div>
      ...
      <div className="max-w-4xl mx-auto px-4 md:px-6 -mt-20 relative z-10">
        ...
        >
          ...
          <div className="flex items-center gap-3 mb-4 flex-wrap">
            ...
            {article.source && (
              <span className="text-[10px] text-[#25364B]/30 flex items-center gap-1">
          ...
          {/* Title */}
          <h1 className="text-3xl md:text-4xl lg:text-5xl text-[#25364B] font-semibold leading-[1.1] mb-4 tracking-tight">
            {article.title}
          </h1>
          ...
          <div className="flex items-center gap-4 mb-8 pb-6 border-b border-[rgba(0,0,0,0.08)] flex-wrap">
            <div className="flex items-center gap-2">
              ...
              <div>
                <p className="text-xs text-[#25364B] font-medium">{article.author}</p>
                <p className="text-[10px] text-[#25364B]/30">AASOTU Media Group</p>
              </div>
            </div>
            <span className="text-[10px] text-[#25364B]/25 hidden md:inline">|</span>
            <span className="flex items-center gap-1 text-[10px] text-[#25364B]/30">
          ...
          <div className="space-y-5 mb-10">
            <p className="text-base md:text-lg text-[#25364B]/70 leading-relaxed font-serif italic border-l-3 border-[#FF9500] pl-4">
              {article.excerpt}
            </p>
            {article.body.map((paragraph, i) => (
              <p
                key={i}
                className="text-sm md:text-base text-[#25364B]/80 leading-[1.7]"
                dangerouslySetInnerHTML={{
                  __html: paragraph
                    .replace(/\*\*(.*?)\*\*/g, '<strong class="text-[#25364B] font-semibold">$1</strong>')
                    .replace(/\n\n/g, '</p><p class="text-sm md:text-base text-[#25364B]/80 leading-[1.7] mt-4">')
                }}
              />
            ))}
          </div>
          ...
          <div className="flex flex-wrap gap-2 mb-8 pb-6 border-b border-[rgba(0,0,0,0.08)]">
            {article.tags.map(tag => (
              <span key={tag} className="flex items-center gap-1 text-[10px] text-[#25364B]/40 bg-[rgba(0,0,0,0.03)] border border-[rgba(0,0,0,0.06)] rounded-full px-3 py-1">
                <Hash size={8} /> {tag}
              </span>
            ))}
          </div>
          ...
          {article.sourceUrl && (
            <div className="mb-8 p-4 bg-[rgba(255,149,0,0.03)] rounded-xl border border-[rgba(255,149,0,0.1)]">
              <p className="text-[10px] text-[#25364B]/30 uppercase tracking-wider mb-1">Original Source</p>
          ...
          <div className="flex items-start gap-4 p-5 bg-white rounded-xl border border-[rgba(0,0,0,0.06)] mb-10">
            ...
            <div>
              <p className="text-sm text-[#25364B] font-medium mb-1">{article.author}</p>
              <p className="text-xs text-[#25364B]/40 leading-relaxed">
          ...
          {related.length > 0 && (
            <div className="mb-10">
              <h3 className="text-xs uppercase tracking-[0.12em] text-[#25364B]/40 font-semibold mb-4 flex items-center gap-2">
      ...
      {/* Footer CTA */}
      <div className="bg-[#14202E] py-12 px-6">
