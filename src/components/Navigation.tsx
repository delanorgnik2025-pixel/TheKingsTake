...
import { Menu, X, LayoutDashboard, LogIn, ChevronDown, User } from 'lucide-react'
        ...
        {mobileOpen && (
          <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }}
            ...
            <div className="pl-4">
              ...
              <Link to="/writing-services#book-publishing" onClick={() => setMobileOpen(false)} className="block text-[#C9B99A] text-base py-2 border-b border-[rgba(240,235,225,0.04)] hover:text-[#FF9500]">Book & Publishing</Link>
